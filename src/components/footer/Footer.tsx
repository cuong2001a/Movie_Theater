            ...
            <ul>
              <li>
                ...
                <ul className={classes.item_logo}>
                  <li>
                    <Link target="_blank" to={"https://www.facebook.com/BHDStar"}>
                      <FaFacebook />
                    </Link>
                  </li>
                  <li>
                    <Link target="_blank" to={"https://www.youtube.com/c/BHDStar"}>
                      <SiYoutube color="red" />
                    </Link>
                  </li>
                  <li>
                    <Link target="_blank" to={"https://www.instagram.com/bhdstar.cineplex/"}>
                      <BsInstagram color="pink" />
                    </Link>
                  </li>
                  <li>
                    <Link target="_blank" to={"https://zalo.me/1884424922722396289"}>
                      <BsTwitter color="cyan" />
                    </Link>
                  </li>
                </ul>
                <img src="https://bhdstar-vn.herokuapp.com/static/media/chungnhanbocongthuong.cb85045e.png" alt="" />
              </li>
            </ul>
          </div>
          <div className={classes.item}>
              ...
              <li>
                ...
                <ul className={classes.item_content}>
                  ...
                  <li className={classes.item_text}>
                    <FaAngleDoubleRight />
                    {""}
                    <span>Giờ làm việc 8:00 - 22:00 (Tất cả các ngày bao gồm lễ) </span>
                  </li>
                </ul>
              </li>
              <li className={classes.contact}>Email Hỗ trợ: CGV.CINEMA.VN@Gmail.com</li>
            </ul>
          </div>
        </div>
      </footer>
