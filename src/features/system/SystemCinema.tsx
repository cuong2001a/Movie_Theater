        ...
        <div className={classes.schedule}>
          <ul className={classes.list_schedule}>
            <li className={classes.item_schedule}>
              <button
                onClick={() => setActive(1)}
                className={active === 1 ? classes.linkActive : classes.link_schedule}
              >
                Lịch chiếu theo rạp
              </button>
            </li>
            ...
            <li className={classes.item_schedule}>
              <button
                onClick={() => setActive(2)}
                className={active === 2 ? classes.linkActive : classes.link_schedule}
              >
                Lịch chiếu theo phim
              </button>
            </li>
          </ul>
          <div className={classes.render}>{active === 1 ? <ListTheater /> : <ListMovie />}</div>
        </div>
      </div>
      <Footer />
    </React.Fragment>
